# Created from suggestion in StackOverflow, http://stackoverflow.com/questions/5507913/generate-rails-migrations-from-a-schema
# relies on copy of current schema just pasted in after rake g migration (CR)
