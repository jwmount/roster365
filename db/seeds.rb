...
certificate_list.each do |name, description, for_contact, for_company, for_equipment, active |
  Certificate.create!( name: name, description: description, for_contact: for_contact, for_company: for_company, 
